...
model = dict(
    ...
    backbone=dict(
        ...
        arch='P5',
        expand_ratio=0.5,
        deepen_factor=0.67,  # 这是 RTMPose-M 的参数，如果是 L 请改为 1.0
        widen_factor=0.75,   # 这是 RTMPose-M 的参数，如果是 L 请改为 1.0
        out_indices=(4, ),
    ...
    head=dict(
        ...
        in_channels=768, # 注意：RTMPose-M 这里是 768，如果是 L 则是 1024
        out_channels=25,
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='RTMPose-m-prosthetics_combined_loss-detach', # 🌟 区分你的 ViT Run
                entity='qitianye1104'
            )
        )
    ],
