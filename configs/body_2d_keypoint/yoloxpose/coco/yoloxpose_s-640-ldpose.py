...
custom_imports = dict(
    imports=[
        ...
        'mmpose.models.heads.ldpose_yolo_anatomy_aware_head',  # 🌟 我们刚刚写的 YOLOX Head 路径
...
model = dict(
    ...
    head=dict(
        ...
        assigner=dict(
            ...
            oks_calculator=dict(
                type='PoseOKS',
                metainfo='configs/body_2d_keypoint/yoloxpose/coco/ld_meta.py'
            )
        ),
        overlaps_power=0.5,
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='YOLOX-S-prosthetics_combined_loss-ldpose',  # 🌟 名字改成了 YOLOX-S
                entity='qitianye1104'
            )
        )
    ],
