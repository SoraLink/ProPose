...
custom_imports = dict(
    imports=[
        ...
        'mmpose.models.heads.ldpose_anatomy_aware_head',
...
load_from = './models/swin/swin_b_p4_w7_coco_384x288-3abf54f9_20220705.pth'
    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='Swin-b-prosthetics_CB_loss_384x288-ldpose',         # 这次 Run 的名字
